...
@asset(deps=[test_crystal_raw])
def test_crystal_pub(
    context: AssetExecutionContext, pipes_databricks: PipesDatabricksClient
):
    
    notebook_path = "/Workspace/Shared/test_crystal_pub"
